...
<body>
	...
	<div class="main">
 	...
 	<div class="register">
 		<form action="CreatePatient_controller" method="post">
 		<table>
 			<tr>
 				<td>
 					<label class="required">Patient SSN ID*</label>
 				</td>
 				<td>
 			...
 			<tr>
 				...
 				<td>
 					<input type="text" id="date_of_admission" name="date_of_admission" placeholder="yyyy-mm-dd" required>
 				</td>
 			</tr>
 			<tr>
 				<td>
 					<label class="required">Type of bed*</label>
 				</td>
 				<td>
 				<select name="type_of_bed" class="type_of_bed" id="type_of_bed" size="1" required>
 			...
 			<tr>
 				...
 				<td>
 					<input type="text" id="address" name="address" required size="30">
 				</td>
 			</tr>
